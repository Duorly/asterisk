...
/**
 * Class VicidialInboundCallbackQueueArchive
 * 
 ...
 * @package App\Models
 */
class VicidialInboundCallbackQueueArchive extends Model
{
	protected $table = 'vicidial_inbound_callback_queue_archive';
